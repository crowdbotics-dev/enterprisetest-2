"""
Django settings for enterprisetest_2 project.
...
ROOT_URLCONF = 'enterprisetest_2.urls'
...
WSGI_APPLICATION = 'enterprisetest_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "enterprisetest_2 API",
    "DESCRIPTION": "API documentation for enterprisetest_2 App",
    "VERSION": "v1",
}
