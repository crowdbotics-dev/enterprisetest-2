...
export const api_v1_bhfh_list = createAsyncThunk("bhfhs/api_v1_bhfh_list", async payload => {
  const response = await apiService.api_v1_bhfh_list(payload);
  return response.data;
});
export const api_v1_bhfh_create = createAsyncThunk("bhfhs/api_v1_bhfh_create", async payload => {
  const response = await apiService.api_v1_bhfh_create(payload);
  return response.data;
});
export const api_v1_bhfh_retrieve = createAsyncThunk("bhfhs/api_v1_bhfh_retrieve", async payload => {
  const response = await apiService.api_v1_bhfh_retrieve(payload);
  return response.data;
});
export const api_v1_bhfh_update = createAsyncThunk("bhfhs/api_v1_bhfh_update", async payload => {
  const response = await apiService.api_v1_bhfh_update(payload);
  return response.data;
});
export const api_v1_bhfh_partial_update = createAsyncThunk("bhfhs/api_v1_bhfh_partial_update", async payload => {
  const response = await apiService.api_v1_bhfh_partial_update(payload);
  return response.data;
});
export const api_v1_bhfh_destroy = createAsyncThunk("bhfhs/api_v1_bhfh_destroy", async payload => {
...
const bhfhsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_bhfh_list.pending, (state, action) => {
